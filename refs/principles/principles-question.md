...
| Reasoning elicitation | additive | Answer depends on a chain of inference — ask for step-by-step reasoning before the verdict | `is this a good argument?` → `Assess each premise for truth and relevance step by step, then state whether the conclusion follows and where it's weakest.` |
